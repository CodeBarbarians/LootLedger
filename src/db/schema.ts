...
export const DEFAULT_CATEGORY_SEED: DefaultCategorySeed[] = [
  { name: 'Grocery / Rent / Expenses', color: '#FF5A1F', percent: 0.55 },
  { name: 'Guilt-Free Spending', color: '#F2C14E', percent: 0.05 },
  { name: 'Debt', color: '#FF6B5C', percent: 0.1 },
  { name: 'Saving — Short Term Goal', color: '#5CD98C', percent: 0.15 },
  { name: 'Saving — Long Term Goal', color: '#4FB6E0', percent: 0.15 },
];
